...
#OR #because I am a litle bit confused by the question

animals = ['cat', 'dog', 'crouching tiger', 'hidden dragon', 'manta ray']
len_animals = (0,len(animals))
for index, animal in zip(range(0,len(animals)), animals):
  print(index, animal, len_animals)
